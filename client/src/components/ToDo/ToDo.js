  ...
  const handleChangePopover = event => {
    ...
    switch (event.target.name) {
      ...
      case 'inbox':
        ...
        break
      case 'done':
        setTasks({ ...tasks, today: false, done: true, inbox: false, location: 'Completed' })
        break
      default:
        break
    }
          ...
          <Col>
            <Dropdown as={ButtonGroup}>
              ...
              <Dropdown.Menu>
                ...
                <Dropdown.Item name='done' onClick={handleChangePopover}>Completed</Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
              ...
              <Col xs={1} md={1}>
                ...
                <OverlayTrigger trigger="click" rootClose placement="left" overlay={<Popover id="popover-basic">
                  ...
                  <Popover.Body >
                    ...
                    {/* <Dropdown.Header>Dropdown header</Dropdown.Header> */}
                    <Dropdown.Item name='delete' onClick={() => { handleDelete(task._id) }}>Delete</Dropdown.Item>
                    {/* <Dropdown.Item name='inbox' onClick={handleChangePopover}>Inbox</Dropdown.Item> */}
                    <Dropdown.Item name='done' onClick={() => { handleDone(task._id) }}>Mark Done</Dropdown.Item>
                ...
                <Col xs={1} md={1}>
                    <OverlayTrigger
                      ...
                      <Popover.Body >
                        ...
                        <Dropdown.Item name='delete' onClick={()=>{handleDelete(task._id)}}>Delete</Dropdown.Item>
                        {/* <Dropdown.Item name='inbox' onClick={handleChangePopover}>Inbox</Dropdown.Item> */}
                        <Dropdown.Item name='done' onClick={() => { handleDone(task._id) }}>Mark Undone</Dropdown.Item>
